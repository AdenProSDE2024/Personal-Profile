<script>
    ...
    let steps = [
        {
            name: "April 23 Florist E-Commerce Store",
            icon: "fa-solid fa-cart-shopping",
            description:
                "April 23 Florist E-Commerce Store is a a merchanising store created with Next.js, Commerce.js & Stripe! Commerce.js is a CMS for managing project and Stripe is used for all transaction handling.",
        },
        {
            name: "Utlimate Todos",
...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="absolute top-0 right-full w-full h-full bg-violet-400 opacity-100 group-hover:translate-x-full z-0 duration-200"
                />
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                    April 23 Florist E-Commerce Store is a a merchanising store
    ...
    <section
        id="about"
        class="py-20 pt-10 lg:pt-16 lg:py-32 flex flex-col gap-16 sm:gap-20
    md:gap-24 relative"
    >
        <div
